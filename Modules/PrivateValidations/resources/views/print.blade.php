...
<div class="shadow p-2 rounded">
 ...
 @php
    ...
    $order = [
    'school_id', 'user_name','school_name', 'approval_number', 'school_category', 'school_level','certificate_available','certificate_file', 'certificate_registration_available', 'lga','ward', 'date_of_approval','approval_letter'
    ];
