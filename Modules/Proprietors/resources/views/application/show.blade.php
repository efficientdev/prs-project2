...
<table class="table">
    ...
    <div class="text-xl">Pending Tasks</div>
@php 
$a=null;
...
<div class="grid grid-cols-2">
    <div class="card mb-3">
        <div class="card-body">
            ...
            <p><strong>Updated At:</strong> {{ \Carbon\Carbon::parse($application->updated_at)->format('d M Y H:i') }}</p>-->
        </div>
    </div>
...
@endif
                ...
                <div class="flex  flex-1 z-1  "> 
                   ...
                   <div class="text-2xl my-3 border-b capitalize pb-1"> requirements</div>
                    	...
                    	<div class="">{{$requirement->requirement_name}}</div>
                    	<div class="text-sm mb-2 text-gray-500">{{$requirement->note??'Detailed '.$requirement->requirement_name}}</div>
                    	@endforeach
        <!--<table class="table">
            @foreach($reqs as $kIndex=>$requirement)
            <tr>
