...
use Modules\PublicValidations\Models\PublicValidation; // Assume this is your model that holds the whole form data 
...
class PRScontroller extends Controller
{
    public function index(Request $request)
    {
        ...
        //->query()
        $forms = PublicValidation::where('submitted',true)
        ...
        return view("publicvalidations::prs.index", compact('forms', 'filters', 'lgas', 'wards'));
    }
