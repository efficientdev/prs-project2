...
<a href="{{route('registration.list')}}">Home</a> 
 ...
 <a href="{{ route('registration.portfolio', ['id' => $form_id ?? 'default']) }}"  >
                   Summary
                </a>
 <a href="{{ route('registration.receipts', ['id' => $form_id ?? 'default']) }}"  >
                   receipts
                </a>
...
<div class="text-3xl my-2"> School Registration Portfolio</div> 
<hr class="my-2" />
