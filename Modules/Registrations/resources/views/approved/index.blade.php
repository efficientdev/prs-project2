 <x-app-layout>
<div class="mb-3 text-xl font-bold">Approved Schools</div>
 ...
 @if($approvals->count() == 0)
        <div class="text-center py-12">
            ...
            <h3 class="text-lg font-medium text-gray-900 capitalize my-1">No Approved Schools yet</h3>
            <p class="text-gray-500 max-w-md mx-auto">When there are Approved Schools they will appear here.</p> 
        </div>
        @else
